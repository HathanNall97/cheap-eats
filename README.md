...
Try to always work on a branch different from main. This has saved many an ass (mine included)
Let's try hard to use the kanban/issue tracking
Please update the kanban board as frequently as possible


Templated stuff

Introduction
This is a template for doing Android development using GitLab and fastlane.
It is based on the tutorial for Android apps in general that can be found here.
...
Blog post: Android publishing with GitLab and fastlane
...
Getting started
First thing is to follow the Android tutorial and
...
Fastlane files
It also has fastlane setup per our blog post on
...
## General
 ...
 - Edit link to the SRS: https://drive.google.com/file/d/1ri03OnrLH3oIRJjKuNgGQuMUKXepNvLY/view?usp=sharing
